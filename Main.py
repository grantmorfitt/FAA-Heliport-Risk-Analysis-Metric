...
class Ui_HeliportRiskAnalysis(object):
    def setupUi(self, HeliportRiskAnalysis):
        ...
        self.ObstacleList = QtWidgets.QTreeWidget(self.centralwidget)
        self.ObstacleList.setGeometry(QtCore.QRect(380, 40, 311, 161))
        self.ObstacleList.setAcceptDrops(True)
        self.ObstacleList.setAutoFillBackground(True)
        self.ObstacleList.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.ObstacleList.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAsNeeded)
        self.ObstacleList.setAnimated(False)
        self.ObstacleList.setObjectName("ObstacleList")
        self.InformationLabel_4 = QtWidgets.QLabel(self.centralwidget)
        self.InformationLabel_4.setGeometry(QtCore.QRect(370, 230, 241, 16))
        ...
        self.RiskLabel.setGeometry(QtCore.QRect(370, 260, 121, 16))
        ...
        self.List1.setGeometry(QtCore.QRect(30, 120, 256, 192))
    ...
    def retranslateUi(self, HeliportRiskAnalysis):
        ...
        self.ObstacleList.headerItem().setText(0, _translate("HeliportRiskAnalysis", "Obstacles"))
