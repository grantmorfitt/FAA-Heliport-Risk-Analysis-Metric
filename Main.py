...
class Ui_HeliportRiskAnalysis(object):
    def setupUi(self, HeliportRiskAnalysis):
        ...
        HeliportRiskAnalysis.resize(874, 445)
        ...
        self.InformationLabel_4.setGeometry(QtCore.QRect(370, 260, 241, 16))
        self.InformationLabel_4.setObjectName("InformationLabel_4")
        self.FAALogo = QtWidgets.QLabel(self.centralwidget)
        self.FAALogo.setGeometry(QtCore.QRect(800, 10, 61, 31))
        ...
        self.RiskLabel.setGeometry(QtCore.QRect(370, 290, 121, 16))
        ...
        self.ObstacleList.setGeometry(QtCore.QRect(360, 60, 411, 181))
